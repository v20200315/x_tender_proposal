...
if __name__ == "__main__":
    ...
    app.update_state(thread, {"user_feedback_1": user_input_1}, as_node="human_feedback_1")
    ...
    app.update_state(thread, {"user_feedback_2": user_input_2}, as_node="human_feedback_2")
